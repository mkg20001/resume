...
\newcommand{\projectNixosPort}{
  ...
  }
  {
    \begin{cvitems}
      ...
      \item {
        \ghs{NixOS/nixpkgs}
        \EN{Various AI-Tools (Openclaw, MCPorter, nexa, etc.)}
        \DE{Diverse AI-Tools (Openclaw, MCPorter, nexa, etc.)}
      }
      \item {
        \ghs{mkg20001/hubs-flake}
        \EN{Mozilla Hubs extended reality service for nixOS\wip}
        \DE{Mozilla Hubs Extenden Reality Dienst für NixOS\wip}
      }
      \item {
  ...
  }
  {
    \begin{cvitems}
      \item {
        ...
        \DE{Async Iterator Hilfbibiliothek für length-prefixed protocol-buffers streams (it-pb-rpc) - 6k wöchentliche downloads}
      }
      \item {
