...
\begin{cventries}
    \cventry%
        {{IDEA-ICS} project: In-depth defense of SCADA and Industrial Control Systems.} % Institute
        {PhD Candidate in Cyber Security -- Dept. of Computer Science, TU/e} % Title
